...
import (
	...
	"github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/servicefwmark/v1/apis/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type K8sV1Interface interface {
	RESTClient() rest.Interface
	ServiceFWMarksGetter
}
...
func (c *K8sV1Client) ServiceFWMarks(namespace string) ServiceFWMarkInterface {
	return newServiceFWMarks(c, namespace)
}
