...
import (
	...
	servicefwmarklister "github.com/ovn-org/ovn-kubernetes/go-controller/pkg/crd/servicefwmark/v1/apis/listers/servicefwmark/v1"
...
func newInformerLister(oType reflect.Type, sharedInformer cache.SharedIndexInformer) (listerInterface, error) {
	...
	case ServiceFWMarkType:
		return servicefwmarklister.NewServiceFWMarkLister(sharedInformer.GetIndexer()), nil
	}
